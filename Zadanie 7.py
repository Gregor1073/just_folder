...
if znak==1 :
    ...
    liczba_a=int(input("podaj podstawe potęgi"))
    liczba_b=int(input("podaj wykładnik potęgi"))
    print("Wynik=", liczba_a**liczba_b)
elif znak==6 :
    liczba_a = int(input("podaj przyprostokątną a"))
    liczba_b = int(input("podaj przyprostokątną b"))
    print("Wynik=", math.hypot(liczba_a, liczba_b))